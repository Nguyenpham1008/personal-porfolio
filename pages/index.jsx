            ...
            <div class="resumo_fn_page">
                ...
                <div class="container">
                  <div class="roww">
                    <div class="resumo_fn_main_title">
                      ...
                      <p class="desc">
                        I &#x27;m a Freelancer Front-end Developer with over 12
                        years of experience. I &#x27;m from San Francisco. I
                        code and create web elements for amazing people around
                        the world. I like work with new people. New people are
                        new experiences.
                      </p>
                    </div>
                          ...
                          <a href="img/cv.jpg" download="">
                            <span class="icon">
                              <svg
                                ...
                                style="enable-background:new 0 0 449.306 449.306"
                                xml:space="preserve"
                        ...
                        <div id="tab3" class="tab_item ">
                          <div class="resumo_fn_progress_bar">
                            <div class="progress_item open" data-value="92">
                              <div class="item_in">
                                ...
                                <span class="progress_percent" style="right:8%">
                                  92%
                                </span>
                                <div class="bg_wrap">
                                  <div
                            ...
                            <div class="progress_item open" data-value="95">
                              <div class="item_in">
                                ...
                                <span class="progress_percent" style="right:5%">
                                  95%
                                </span>
                                <div class="bg_wrap">
                                  <div
                          ...
                          <div class="resumo_fn_desc">
                            <p>
                              ...
                              minimal design, clean typography and well-written
                              code, located in San Francisco. Provide high
                              quality and cost effective offshore web and
                              software development services. Wide range of web
                              and software development services across the
                              world.
                            </p>
                          </div>
                        </div>
              ...
              <section id="portfolio">
                ...
                <div class="container noright">
                  <div class="roww">
                    <div
                      class="swiper owl-carousel modal_items"
                      data-from="portfolio"
                    >
                      <div class="swiper-wrapper">
                        <div
                          class="swiper-slide item modal_item swiper-slide-duplicate"
                        ...
                        <div
                          class="swiper-slide item modal_item"
                      ...
                      <div class="swiper owl-carousel">
                        <div class="swiper-wrapper">
                          ...
                          >
                            <div class="title_holder">
                              <p class="desc">
                                “ Had a problem with the layout after
                                Installation- found no approach. The support
                                reacted quickly and competently. And solved the
                                problem between Elementor and a WordPress
                                update. Great! ”
                              </p>
                          ...
                          >
                            <div class="title_holder">
                              <p class="desc">
                                “ They really nailed it. This is one of the best
                                themes I have seen in a long time. Very nice
                                design with lots of customization available.
                                Many of my clients have chosen this theme for
                          ...
                          >
                            <div class="title_holder">
                              <p class="desc">
                                “ This was exactly what I needed for my
                                portfolio, and it looks great. I had a couple
                                issues that support helped troubleshoot both via
                                email and on the comments, which definitely made
                                it worth the price. I &#x27;m very pleased with
                                this purchase. ”
                              </p>
                        ...
                        <li>
                          <div class="item modal_item" data-index="1">
                            ...
                            <div class="fn__hidden">
                              ...
                              <p class="fn__desc">
                                Sed ornare tellus a odio bibendum, at tristique
                                sapien malesuada. Proin sagittis maximus
                                accumsan. Class aptent taciti sociosqu ad litora
                                torquent per conubia nostra, per inceptos
                                himenaeos. Lorem ipsum dolor sit amet,
                                consectetur adipiscing elit. Quisque gravida
                                quam sit amet elit varius tempor. Pellentesque
                                purus eros, blandit eu mollis vel, commodo eget
                                orci. Proin vel hendrerit ex. Vivamus ut ex at
                                nunc consectetur efficitur ut quis est. Proin
                                posuere orci eget vulputate fringilla. Curabitur
                                placerat massa eget efficitur cursus. Sed
                                sollicitudin rhoncus blandit. Nam accumsan
                                vestibulum enim. Sed rutrum eu leo pellentesque
                                lobortis. Integer ornare fringilla arcu, eu
                                mattis risus convallis in.
                              </p>
                              <p class="fn__desc">
                                Quisque dui metus, eleifend at enim ac,
                                imperdiet sagittis dolor. Vestibulum ipsum quam,
                                feugiat non velit sit amet, pulvinar varius
                                nisl. Mauris tristique, ipsum sit amet lacinia
                                congue, mauris magna tempus nibh, in mollis eros
                                enim a tortor. Morbi enim arcu, tristique vitae
                                mi nec, hendrerit pharetra metus. Phasellus id
                                feugiat purus. In vel elit eu lacus ultrices
                                feugiat. Etiam at aliquet mi. Nunc sit amet
                                libero sit amet lectus pellentesque sagittis.
                                Curabitur blandit ante quis erat dapibus
                                viverra. Maecenas consequat pulvinar pulvinar.
                                Donec in aliquam arcu. Donec eu laoreet dolor.
                                Ut nisi lectus, pulvinar ac mattis quis, pretium
                                ac nulla. Morbi sed ligula ultrices, ornare
                                mauris id, auctor arcu. Sed pellentesque ex sed
                                erat faucibus, ultrices vehicula ex dapibus.
                                Aenean venenatis metus eros, vel faucibus lorem
                                porttitor eu.
                              </p>
                              <p class="fn__desc">
                                Sed porttitor augue erat, vitae convallis odio
                                viverra id. In nec finibus elit. Nullam ac
                                sodales nunc, vel sagittis elit. Ut condimentum
                                ex ipsum, eu ornare odio aliquam eu. Ut iaculis
                                eros quam, eu bibendum tellus convallis quis.
                                Donec sapien risus, consequat ut magna nec,
                                interdum porta nisl. Vivamus pulvinar hendrerit
                                finibus. Nunc molestie lacinia risus, id mattis
                                nunc euismod ac. Nam eu orci felis. Quisque ut
                                elementum quam. Vivamus pulvinar nisi nunc, ut
                                faucibus turpis tincidunt eget. Fusce nec ex
                                quis odio laoreet consequat. Duis faucibus metus
                                id feugiat sodales. Sed eu ligula eget quam
                                ultricies tincidunt. Morbi sodales nunc ultrices
                                justo pellentesque, ac mattis mi sagittis. Morbi
                                ut consectetur neque.
                              </p>
                            </div>
                          </div>
                        </li>
                        ...
                        <li>
                          <div class="item modal_item" data-index="4">
                            ...
                            <div class="title_holder">
                              ...
                              <h3>
                                <a href="#">
                                  What You Know About Design And What You Don
                                  &#x27;t Know About Design.
                                </a>
                              </h3>
                            </div>
                        ...
                        <li class="be_animated">
                          <div class="item modal_item" data-index="5">
                            ...
                            <div class="title_holder">
                              ...
                              <h3>
                                <a href="#">
                                  Forgive Yourself for Not Being Perfect. Then
                ...
                <div class="container">
                  <div class="roww resumo_fn_contact">
                    ...
                    <form class="contact_form">
                      ...
                      <div class="empty_notice" style="display:none">
            ...
            <div class="right_in">
              <div class="right_top">
                ...
                <div class="title_holder">
                  <h5>Hi There! I am</h5>
                  <p class="h3">
                    <span class="animated_title"></span>
                  </p>
                </div>
              </div>
                  ...
                  <li>
                    <a href="#" target="_blank">
                      <svg
                        ...
                        style="enable-background:new 0 0 511.958 511.958"
                        xml:space="preserve"
                        class="fn__svg replaced-svg"
                      >
                        <g>
